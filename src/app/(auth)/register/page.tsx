  ...
  async function onSubmit(data: FormValues) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setError(body.message ?? "Pendaftaran gagal.");
        setErrorKey((k) => k + 1);
        return;
      }
          ...
          <FadeInStagger staggerDelay={0.05}>
            <FadeInItem>
              <div className="mb-3">
                ...
                />
                {errors.name && (
                  <p className="text-2xs text-danger-bold mt-1">{errors.name.message}</p>
                )}
              </div>
            </FadeInItem>
            ...
            <FadeInItem>
              <div className="mb-3">
                ...
                />
                {errors.email && (
                  <p className="text-2xs text-danger-bold mt-1">{errors.email.message}</p>
                )}
              </div>
            </FadeInItem>
            ...
            <FadeInItem>
              <div className="mb-5">
                ...
                />
                {errors.password && (
                  <p className="text-2xs text-danger-bold mt-1">{errors.password.message}</p>
                )}
              </div>
            </FadeInItem>
            ...
            <FadeInItem>
              {error && (
                <p className="text-xs text-danger-bold mb-3 text-center">{error}</p>
              )}
