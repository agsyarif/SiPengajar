...
4. DILARANG menggunakan tag HTML tanpa class yang ditentukan: JANGAN <h2> tanpa class="section-header", JANGAN <h3> tanpa class="subsection-title", JANGAN <h4> tanpa class="meeting-header", JANGAN <table> tanpa class yang sesuai
5. Buat SEMUA ${input.pertemuan} pertemuan dengan konten berbeda dan lengkap
6. Bahasa Indonesia baku, spesifik, kontekstual
7. Bungkus SELURUH output HTML dengan <div class='modul-content'>...</div>`;
}
